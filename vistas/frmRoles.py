...
"")
        ...
        self.btn_eliminar_2 = QtWidgets.QPushButton(frmRoles)
        self.btn_eliminar_2.setMinimumSize(QtCore.QSize(150, 50))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.btn_eliminar_2.setFont(font)
        self.btn_eliminar_2.setStyleSheet("border-style: outset;\n"
"background-color: #8458B3;\n"
"color: rgb(235, 232, 235);\n"
"")
        ...
        self.cbox_opcion = QtWidgets.QComboBox(frmRoles)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.PlaceholderText, brush)
        self.cbox_opcion.setPalette(palette)
        self.cbox_opcion.setFrame(True)
        self.cbox_opcion.setObjectName("cbox_opcion")
        self.gridLayout.addWidget(self.cbox_opcion, 1, 3, 1, 3)
        self.cbox_rol = QtWidgets.QComboBox(frmRoles)
    ...
    def retranslateUi(self, frmRoles):
        ...
        self.btn_filtrar.setToolTip(_translate("frmRoles", "Filtrar por..."))
