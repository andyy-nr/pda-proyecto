...
class Ui_frmRolesUsuario(object):
    def setupUi(self, frmRolesUsuario):
        ...
        frmRolesUsuario.resize(1386, 758)
...
"")
        ...
        self.cbox_opcion = QtWidgets.QComboBox(frmRolesUsuario)
...
"")
        ...
        self.tbl_opcionRol = QtWidgets.QTableWidget(frmRolesUsuario)
        ...
        self.label = QtWidgets.QLabel(frmRolesUsuario)
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, frmRolesUsuario):
        ...
        frmRolesUsuario.setWindowTitle(_translate("frmRolUsuario", "Gestión de Rol-Usuario"))
        ...
        self.lbl_nombre_usuario.setText(_translate("frmRolUsuario", "<html><head/><body><p align=\"right\">Nombre de usuario</p></body></html>"))
