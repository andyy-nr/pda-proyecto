...
"")
    ...
    def retranslateUi(self, frmOpcionRol):
        ...
        frmOpcionRol.setWindowTitle(_translate("frmOpcionRol", "Gestión de Rol-Usuario"))
        ...
        self.btn_eliminar.setToolTip(_translate("frmOpcionRol", "Eliminar información de Rol-Usuario"))
        self.btn_eliminar.setText(_translate("frmOpcionRol", "Eliminar"))
        self.btn_agregar.setToolTip(_translate("frmOpcionRol", "Agregar información de Rol-Usuario"))
        self.btn_agregar.setText(_translate("frmOpcionRol", "Agregar"))
        self.cbox_opcion.setPlaceholderText(_translate("frmOpcionRol", "Usuario*"))
        self.btn_filtrar.setToolTip(_translate("frmOpcionRol", "Filtrar por..."))
