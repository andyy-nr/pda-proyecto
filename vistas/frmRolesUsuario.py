...
class Ui_frmRolesUsuario(object):
    def setupUi(self, frmRolesUsuario):
        frmRolesUsuario.setObjectName("frmRolesUsuario")
        frmRolesUsuario.resize(1276, 758)
        frmRolesUsuario.setMaximumSize(QtCore.QSize(16777215, 2000))
        ...
        frmRolesUsuario.setPalette(palette)
        self.gridLayout = QtWidgets.QGridLayout(frmRolesUsuario)
        self.gridLayout.setObjectName("gridLayout")
        self.cbox_rol = QtWidgets.QComboBox(frmRolesUsuario)
        self.cbox_rol.setMinimumSize(QtCore.QSize(400, 40))
        self.cbox_rol.setObjectName("cbox_rol")
        self.gridLayout.addWidget(self.cbox_rol, 1, 7, 1, 1)
        self.tbl_roles_usuario = QtWidgets.QTableView(frmRolesUsuario)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tbl_roles_usuario.sizePolicy().hasHeightForWidth())
        self.tbl_roles_usuario.setSizePolicy(sizePolicy)
        self.tbl_roles_usuario.setMinimumSize(QtCore.QSize(0, 500))
        self.tbl_roles_usuario.setMaximumSize(QtCore.QSize(16777215, 500))
        self.tbl_roles_usuario.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.tbl_roles_usuario.setObjectName("tbl_roles_usuario")
        self.gridLayout.addWidget(self.tbl_roles_usuario, 4, 0, 1, 8)
        self.txt_buscar = QtWidgets.QLineEdit(frmRolesUsuario)
        ...
        self.txt_codigo = QtWidgets.QLineEdit(frmRolesUsuario)
        ...
        self.cbox_usuario = QtWidgets.QComboBox(frmRolesUsuario)
        self.cbox_usuario.setMinimumSize(QtCore.QSize(400, 40))
        self.cbox_usuario.setObjectName("cbox_usuario")
        self.gridLayout.addWidget(self.cbox_usuario, 1, 3, 1, 4)
        self.btn_regresar = QtWidgets.QPushButton(frmRolesUsuario)
...
"")
        ...
        self.btn_eliminar = QtWidgets.QPushButton(frmRolesUsuario)
...
"")
        ...
        self.frame_2 = QtWidgets.QFrame(frmRolesUsuario)
...
"")
        ...
        self.btn_agregar = QtWidgets.QPushButton(frmRolesUsuario)
...
"")
        ...
        self.frame = QtWidgets.QFrame(frmRolesUsuario)
        ...
        self.btn_editar = QtWidgets.QPushButton(frmRolesUsuario)
...
"")
        ...
        self.btn_limpiar = QtWidgets.QPushButton(frmRolesUsuario)
...
"")
        ...
        self.retranslateUi(frmRolesUsuario)
        QtCore.QMetaObject.connectSlotsByName(frmRolesUsuario)

    def retranslateUi(self, frmRolesUsuario):
        _translate = QtCore.QCoreApplication.translate
        frmRolesUsuario.setWindowTitle(_translate("frmRolesUsuario", "Información de Rol-Usuario"))
        self.cbox_rol.setPlaceholderText(_translate("frmRolesUsuario", "Rol*"))
        self.txt_buscar.setPlaceholderText(_translate("frmRolesUsuario", "Buscar"))
        self.txt_codigo.setPlaceholderText(_translate("frmRolesUsuario", "Codigo"))
        self.cbox_usuario.setPlaceholderText(_translate("frmRolesUsuario", "Usuario*"))
        self.btn_eliminar.setText(_translate("frmRolesUsuario", "Eliminar"))
        self.btn_agregar.setText(_translate("frmRolesUsuario", "Agregar"))
        self.lbl_foto.setText(_translate("frmRolesUsuario", "Foto"))
        self.lbl_nombre_usuario.setText(_translate("frmRolesUsuario", "<html><head/><body><p align=\"right\">Nombre de usuario</p></body></html>"))
        self.btn_editar.setText(_translate("frmRolesUsuario", "Editar"))
        self.btn_limpiar.setText(_translate("frmRolesUsuario", "Limpiar"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    frmRolesUsuario = QtWidgets.QWidget()
    ui = Ui_frmRolesUsuario()
    ui.setupUi(frmRolesUsuario)
    frmRolesUsuario.show()
    sys.exit(app.exec_())
