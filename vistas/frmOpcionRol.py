...
"")
        ...
        self.btn_editar = QtWidgets.QPushButton(frmOpcionRol)
...
"")
    ...
    def retranslateUi(self, frmOpcionRol):
        ...
        frmOpcionRol.setWindowTitle(_translate("frmOpcionRol", "Información de Opción-Rol"))
        self.btn_eliminar.setText(_translate("frmOpcionRol", "Eliminar"))
        self.lbl_foto.setText(_translate("frmOpcionRol", "Foto"))
        ...
        self.btn_editar.setText(_translate("frmOpcionRol", "Editar"))
