...
"")
        ...
        self.cbox_empleado = QtWidgets.QComboBox(frmDependientes)
        self.cbox_empleado.setMinimumSize(QtCore.QSize(400, 40))
        self.cbox_empleado.setObjectName("cbox_empleado")
        self.gridLayout.addWidget(self.cbox_empleado, 2, 3, 1, 3)
    ...
    def retranslateUi(self, frmDependientes):
        ...
        self.cbox_empleado.setPlaceholderText(_translate("frmDependientes", "Empleado*"))
