...
"")
        ...
        self.t = QtWidgets.QTableWidget(frmEmpleados)
        ...
        self.t.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.t.setObjectName("t")
        self.t.setColumnCount(9)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.t.setHorizontalHeaderItem(8, item)
        self.t.horizontalHeader().setDefaultSectionSize(158)
